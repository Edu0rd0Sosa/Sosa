...
# Agregar encabezado
 ...
 # Ajustar tamaño de la tabla
    ...
    def ingresar(self):
        ...
        datos=(proveedor,medicamentos,unidades,ingreso,estado,caducidad)
        if proveedor and medicamentos and unidades and ingreso and estado and caducidad !=' ':
         ...
         self.buscador1.delete(0,"end")
         self.buscador2.delete(0,"end")
         self.buscador3.delete(0,"end")
         self.buscador4.delete(0,"end")
         self.buscador5.delete(0,"end")  
